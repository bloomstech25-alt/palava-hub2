...
export default function VideoCallModal({ visible, callId, name, avatar, school, onEnd }: Props) {
        ...
        {fullUrl ? (
          ...
          <View style={styles.loading}>
            ...
            <View style={styles.connectingRow}>
              ...
              <Text style={styles.connecting}>{error || "Connecting video call..."}</Text>
            </View>
          </View>
        )}
