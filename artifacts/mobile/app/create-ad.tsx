      ...
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={[styles.successScreen, { paddingTop: topPad + 40 }]}>
          ...
          <Text style={[styles.successBody, { color: colors.mutedForeground }]}>
            Your ad is under review by our admin team. Once approved, it will start showing to students across Lafa.
          </Text>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Text style={[styles.terms, { color: colors.mutedForeground }]}>
          By submitting, you agree to Lafa's advertising guidelines. All ads are reviewed before going live.
        </Text>
      </ScrollView>
    </View>
  );
